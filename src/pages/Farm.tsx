      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Tabs defaultValue="home" className="space-y-6">
          ...
          <TabsContent value="home" className="space-y-6">
            ...
            <AnimatedFarm farmName={profile?.shop_name || "Trang trại của bạn"} balance={farm?.account_balance || 0} totalEggs={eggInventory.total_eggs} totalChickens={chickens.reduce((sum, chicken) => sum + chicken.quantity, 0)} chickens={chickens} farmId={farm?.id || ""} userId={user?.id || ""} onCollectEgg={collectEggs} onSellEggs={sellEggs} />
