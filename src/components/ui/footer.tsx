...
const Footer = () => {
  const footerSections = [
    {
      title: 'Liên hệ',
      items: [
        { icon: Phone, text: 'Hotline: 1900-XXX-XXX', href: 'tel:1900xxxxxx' },
        { icon: Mail, text: 'Email: support@nuoiga5stars.vn', href: 'mailto:support@nuoiga5stars.vn' },
        { icon: MapPin, text: 'Zalo: 0987-XXX-XXX', href: 'https://zalo.me' },
      ]
    },
    {
      title: 'Chính sách',
      items: [
        ...
        { text: 'Chính sách hoàn tiền', href: '/refund' },
        { text: 'Điều khoản sử dụng', href: '/terms' },
        { text: 'Hướng dẫn nuôi gà', href: '/guide' },
      ]
    },
    {
      title: 'Dịch vụ',
      items: [
        { text: 'Nuôi gà từ xa', href: '/services/remote' },
        { text: 'Giao trứng tận nhà', href: '/services/delivery' },
        { text: 'Bán trứng kiếm lời', href: '/services/selling' },
        { text: 'Cửa hàng phụ kiện', href: '/shop' },
      ]
    }
  ];
  ...
  return (
    <footer className="bg-card border-t border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-xl font-bold text-primary">Nuôi Gà 5Stars</span>
            </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            {socialLinks.map((social, index) => (
              <a
                ...
                className="w-10 h-10 rounded-full bg-muted hover:bg-primary transition-all duration-200 flex items-center justify-center group hover:shadow-medium"
              >
      ...
      <div className="absolute bottom-8 right-8 text-xl opacity-20 animate-float" style={{ animationDelay: '1s' }}>🥚</div>
    </footer>
  );
};
