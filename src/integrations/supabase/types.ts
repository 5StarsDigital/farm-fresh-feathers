...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      delete_service_package: { Args: { p_package_id: string }; Returns: Json }
      disable_insufficient_balance_check: { Args: never; Returns: boolean }
      disable_process_monthly_billing: { Args: never; Returns: boolean }
      ...
      format_vnd_amount: { Args: { amount: number }; Returns: string }
      generate_package_code: { Args: never; Returns: string }
      ...
      resync_user_chickens: { Args: { p_farm_id: string }; Returns: Json }
    }
    Enums: {
